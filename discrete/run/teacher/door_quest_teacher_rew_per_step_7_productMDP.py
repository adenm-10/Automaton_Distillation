...
from discrete.run.env.door_quest_7 import door_quest_7_rew_per_step_env_config
...
config = teacher_config_v1(door_quest_7_rew_per_step_env_config, "door_quest_teacher_rew_per_step_7_productMDP", device, 
