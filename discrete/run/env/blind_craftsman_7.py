...
blind_craftsman_config_7 = MineWorldConfig(
    shape=(7, 7),
...
blind_craftsman_env_config_7 = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config_7}
)

blind_craftsman_exp_env_config_7 = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config_7},
...
blind_craftsman_rew_per_step_env_config_7 = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config_7},
...
blind_craftsman_rew_per_step_env_config_7_cont = EnvConfig(
