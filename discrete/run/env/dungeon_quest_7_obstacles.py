...
dungeon_quest_rew_per_step_env_config_7_obstacles = EnvConfig(
...
dungeon_quest_aps_obstacles = AP_list[sequence_level]
dungeon_quest_ltlf_obstacles = LTLF_list[sequence_level]

print(f"Dungeon Quest LTLF: {dungeon_quest_aps_obstacles}")
print("============================================\n\n")
