...
blind_craftsman_config_7_obstacles = MineWorldConfig(
    shape=(7, 7),
...
blind_craftsman_env_config_7_obstacles = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config_7_obstacles}
)

blind_craftsman_exp_env_config_7_obstacles = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config_7_obstacles},
...
blind_craftsman_rew_per_step_env_config_7_obstacles = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config_7_obstacles},
...
blind_craftsman_rew_per_step_env_config_7_obstacles_cont = EnvConfig(
