...
dungeon_quest_config = MineWorldConfig(
    shape=(10, 10),
...
dungeon_quest_config_cont = MineWorldConfig(
    shape=(2),
    tile_shape=(10, 10),
    initial_position=None,
    placements=[
...
dungeon_quest_rew_per_step_env_config_cont = EnvConfig(
    env_name="MineWorldEnv-v1",
    kwargs={"config": dungeon_quest_config_cont},
    wrapper_cls=RewEveryStep,
    wrapper_kwargs={"rew_per_step": -0.1}
)

dungeon_quest_env_config = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": dungeon_quest_config}
)

dungeon_quest_exp_env_config = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": dungeon_quest_config},
...
dungeon_quest_rew_per_step_env_config = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": dungeon_quest_config},
    wrapper_cls=RewEveryStep,
    wrapper_kwargs={"rew_per_step": -0.1}
