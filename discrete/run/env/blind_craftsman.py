...
blind_craftsman_config = MineWorldConfig(
    shape=(10, 10),
...
blind_craftsman_env_config = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config}
)

blind_craftsman_exp_env_config = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config},
...
blind_craftsman_rew_per_step_env_config = EnvConfig(
    env_name="MineWorldEnv-v0",
    kwargs={"config": blind_craftsman_config},
