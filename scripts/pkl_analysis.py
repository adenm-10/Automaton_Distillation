...
if __name__ == "__main__":
    ...
    # path_distill_to_out = "test_output/369875/dragon-r_10_key_r_1_sword_i_1_shield_i_1_seq-level_2/rew_and_steps_lists.pkl"
    ...
    path_independent_to_out = "test_output/369875/dragon-r_10_key_r_1_sword_i_1_shield_i_1_seq-level_2"
    ...
    plt.savefig(f'{path_independent_to_out}/Student_Rewards_Comp_{x_length}_Episodes.png')
    ...
    plt.savefig(f'{path_independent_to_out}/Student_Steps_Comp_{x_length}_Episodes.png')
